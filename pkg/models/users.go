...
var UserRels = struct {
	...
	ChannelNameMessages     string
	ChannelNameMessages     string
	ChannelNameUserMessages string
	ChannelNameUserMessages string
	ChannelNameUserMessages string
	ChannelNameUserMessages string
}{
	...
	ChannelNameMessages:     "ChannelNameMessages",
	ChannelNameMessages:     "ChannelNameMessages",
	ChannelNameUserMessages: "ChannelNameUserMessages",
	ChannelNameUserMessages: "ChannelNameUserMessages",
	ChannelNameUserMessages: "ChannelNameUserMessages",
	ChannelNameUserMessages: "ChannelNameUserMessages",
}
...
type userR struct {
	...
	ChannelNameMessages     MessageSlice
	ChannelNameMessages     MessageSlice
	ChannelNameUserMessages UserMessageSlice
	ChannelNameUserMessages UserMessageSlice
	ChannelNameUserMessages UserMessageSlice
	ChannelNameUserMessages UserMessageSlice
}
...
// ChannelNameUserMessages retrieves all the user_message's UserMessages with an executor via channel_name column.
func (o *User) ChannelNameUserMessages(mods ...qm.QueryMod) userMessageQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"user_messages\".\"channel_name\"=?", o.ChannelName),
	)
...
func (o *User) ChannelNameUserMessages(mods ...qm.QueryMod) userMessageQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"user_messages\".\"channel_name\"=?", o.Sender),
	)
...
// ChannelNameUserMessages retrieves all the user_message's UserMessages with an executor via sender column.
func (o *User) ChannelNameUserMessages(mods ...qm.QueryMod) userMessageQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	...
	queryMods = append(queryMods,
		qm.Where("\"user_messages\".\"sender\"=?", o.ChannelName),
	)
...
func (o *User) ChannelNameUserMessages(mods ...qm.QueryMod) userMessageQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"user_messages\".\"sender\"=?", o.Sender),
	)
...
// LoadChannelNameUserMessages allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadChannelNameUserMessages(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(qm.From(`user_messages`), qm.WhereIn(`user_messages.channel_name in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.ChannelNameUserMessages = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ChannelName == foreign.ChannelName {
				local.R.ChannelNameUserMessages = append(local.R.ChannelNameUserMessages, foreign)
				if foreign.R == nil {
					foreign.R = &userMessageR{}
				}
				foreign.R.ChannelName = local
...
func (userL) LoadChannelNameUserMessages(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(qm.From(`user_messages`), qm.WhereIn(`user_messages.sender in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
// AddChannelNameUserMessages adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.ChannelNameUserMessages.
// Sets related.R.ChannelName appropriately.
func (o *User) AddChannelNameUserMessages(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserMessage) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.ChannelName = o.ChannelName
			...
			values := []interface{}{o.ChannelName, rel.ChannelName, rel.Sender, rel.MessageID}
	...
	if o.R == nil {
		o.R = &userR{
			ChannelNameUserMessages: related,
		}
	} else {
		o.R.ChannelNameUserMessages = append(o.R.ChannelNameUserMessages, related...)
	}
...
func (o *User) AddChannelNameUserMessages(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserMessage) error {
	...
	for _, rel := range related {
		if insert {
			...
			values := []interface{}{o.Sender, rel.ChannelName, rel.Sender, rel.MessageID}
