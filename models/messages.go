...
type Message struct {
	...
	Sender      null.String `boil:"sender" json:"sender,omitempty" toml:"sender" yaml:"sender,omitempty"`
...
var MessageWhere = struct {
	...
	Sender:      whereHelpernull_String{field: "\"messages\".\"sender\""},
	ChannelName: whereHelpernull_String{field: "\"messages\".\"channel_name\""},
	Message:     whereHelpernull_String{field: "\"messages\".\"message\""},
}
...
var (
	messageAllColumns            = []string{"id", "created_at", "updated_at", "deleted_at", "sender", "channel_name", "message"}
	messageColumnsWithoutDefault = []string{"created_at", "updated_at", "deleted_at", "sender", "channel_name", "message"}
